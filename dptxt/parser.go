...
var (
	...
	ErrorNoOpenParenthesis            = errors.New("段落の末尾に日付けを指定してください。")
	ErrorNoCloseParenthesis           = errors.New("段落の末尾に日付けを指定してください。")
	ErrorExtraTextAfterDate           = errors.New("段落の末尾に日付けを指定してください。")
)
